...
<div id="page" class="hfeed site">
	...
	<header id="pre" class="site-header" role="banner">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
				<a href="<?php echo MB_BLOGURL; ?>" title="<?php echo MB_BLOGDESC; ?>"><img src="<?php echo MB_BLOGTHEME; ?>/assets/images/mam.logo.png" alt="<?php __('Madrid a medias logotype','_mbbasetheme'); ?>" /></a>
				</div><!-- col- -->
			</div><!-- row -->
		</div><!-- container -->
